...
#    'resnet101': '/mnt/lustre/dingmingyu/kaggle/checkpoints/model_best.pth.tar',
    'resnet101': '/mnt/lustre/dingmingyu/.torch/models/',
...
def rgb_resnet101(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # # 3. load the new state dict
        #model.load_state_dict(model_dict)
        params = torch.load(model_urls['resnet101'])
