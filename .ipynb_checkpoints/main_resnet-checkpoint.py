...
parser.add_argument('--dir_path', default='../data/datasets/')
...
def main():
    ...
    train_data = MyDataset(os.path.join(args.dir_path, 'train.txt'), args.dir_path, args.new_width, args.new_length,
                           train_transform)
    val_data = MyDataset(os.path.join(args.dir_path, 'val.txt'), args.dir_path, args.new_width, args.new_length,
                         val_transform)
...
def build_model():
    ...
    model = getattr(resnet, model_name)(pretrained=True, num_classes=128)
